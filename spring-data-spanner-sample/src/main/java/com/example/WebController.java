...
public class WebController {
  ...
  @Autowired
  private SpannerSchemaToolsSample spannerSchemaToolsSample;
  ...
  public ModelAndView createCustomer(
    ...
    Customer customer = new Customer(customerUuid, name, email);
  ...
  public ModelAndView orderCoffee(
    ...
    for (int i = 0; i < coffeeCount; i++) {
      String coffeeUuid = UUID.randomUUID().toString();
      coffeeList.add(new Coffee(currentCustomer.getId(),coffeeUuid,size));
    }
